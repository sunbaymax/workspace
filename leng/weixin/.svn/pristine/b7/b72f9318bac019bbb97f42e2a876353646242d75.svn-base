$(document).ready(function() {
	...
	function myMachineList() {
		$.ajax({
			...
			success: function(data) {
				...
				//console.log(_json);
				$(".userN_form span").html(_json.resultCode.admin_user);
	...
	function machine_post_change() {
		...
		/*console.log(_shebeiName);
		console.log(_dayinBiaoTou);
		console.log(fly_kaiqishijian);
		console.log(fly_huanxingshijian);
		console.log(caiJi_jiange);
		console.log(fasong_jiange);
		console.log(_baojingshangxian);
		console.log(_baojingxiaxian);
		console.log(_hegeshangxian);
		console.log(_hegexiaxian);
		console.log(_tel_number);*/
