	...
	<body>
     ...
     <s style="display:inline-block;width: 80%;height: 1px;margin-top:3px;margin-left: 10%; border-bottom: 1px solid #ccc;"></s>
		...
		<p style="text-align: center;font-size: 1.2rem;margin-top: 20px;">
			感谢参与，祝你心情愉快！<img src="images/smile.png" style="display:inline-block;width:2rem ;height:2rem ;line-height: 2rem;" /></br>技术支持：中集冷云（北京）冷链科技有限公司
		</p>
		...
		<script type="text/javascript">
		    ...
		    if(_name == "") {
					...
					$("form p:nth-of-type(5)").html("请选择真实的公司名称").css({
						color: "red"
					});
				}
				else{
