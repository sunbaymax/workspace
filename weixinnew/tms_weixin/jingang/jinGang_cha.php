...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/jinGang.css" />
</head>
...
<body>
	<div class="header">
		...
		<span>
				<a href="jinGang.html">进港</a>
			</span> 进港查询
	</div>
	<form class="jinGangCha_content">
	...
	<script src="../js/jinGang.js" type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript">
		...
		$(".jinGangCha_content img").on("click", function() {
			wx.scanQRCode({
				needResult: 1, // 默认为0，扫描结果由微信处理，1则直接返回扫描结果，
				scanType: ["qrCode", "barCode"], // 可以指定扫二维码还是一维码，默认二者都有
				success: function(res) {
					var result = res.resultStr; // 当needResult 为 1 时，扫码返回的结果;
					$(".jinGangCha_content input").val(result.replace("CODE_128,", ""));
				}
			});
		});
	</script>
