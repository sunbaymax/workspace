		...
		<div class="content">
			...
			<form action="jiekou_doBox.php" method="post">
				<ul>	
					...
					<li><i class="icon iconfont icon-riqi1"></i> <span>  时&nbsp;&nbsp;&nbsp;间：</span> <input id="history_end_time" style="margin-left: 20px;padding-left: 28px;" name="s2" readonly onFocus="WdatePicker({startDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'})" /><br /></li>	
				</ul>
