...
function connect_mysql(){
	$link = mysqli_connect("rm-2ze3o57ph836pk46r.mysql.rds.aliyuncs.com","test01","Pzg790915");
		if (!$link)
		  {
...
function receiveEvent($object)
{
    ...
    switch($object->Event)
    {
        case "subscribe":
			...
			$sql="INSERT INTO tb_weixin_lengyunuser (openid,nickname,sex,country,province,city,headimgurl,subscribe,subscribe_time) values('$openid','$nickname','$sex','$country','$province','$city','$headimgurl','$subscribe','$subscribe_time')";
		    $link = connect_mysql();
		    mysqli_query($link,$sql);
		    mysqli_close($link);
            break;
