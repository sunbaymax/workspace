...
class wxPay {
    //配置参数信息
    const SHANGHUHAO = "1406387502";//商户号
    const PARTNERKEY = "pT96decT4dMe35kO3olOs9Pan2MMJb5H";    //api，商户后台
    //核心支付函数,参数：请求地址和参数
    function pay($url,$obj) {
        $obj['nonce_str'] = $this->create_noncestr();    //创建随机字符串
        $stringA = $this->create_qianming($obj,false);    //创建签名
        $stringSignTemp = $stringA."&key=pT96decT4dMe35kO3olOs9Pan2MMJb5H";    //签名后加api
