    ...
    if($RX_TYPE=="event")
    {
        ...
        if(!empty( $keyword ))
        {
           if($keyword=="设备"||$keyword=="查询"||$keyword=="冷链"||$keyword=="监控"||$keyword=="我的设备"||$keyword=="中集冷云"){
                ...
                $msgType = "text";
                $contentStr = "<a href=\"https://hd.faisco.cn/15084413/8-OFLzYSb5c35xQRFUCppg/load.html?style=0\">参与抽奖</a>/微笑\n备注：请本人参与抽奖，代抽一律作废处理，感谢您的参与与配合!本次活动最终解释权归中集冷云（北京）供应链管理有限公司所有";
                $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
                echo $resultStr;
                ...
                $msgType = "text";
                $contentStr = "/微笑<a href=\"http://www.ccsc58.cc/leng/zhuanpans/yongHuXinXi.html\">参与抽奖</a>/微笑\n备注：请本人参与抽奖，代抽一律作废处理，感谢您的参与与配合!本次活动最终解释权归中集冷云所有";
                $resultStr = sprintf($textTpl, $fromUsername, $toUsername, $time, $msgType, $contentStr);
                echo $resultStr;
