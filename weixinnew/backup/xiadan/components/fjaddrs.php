...
<html lang="en">
	...
	<script>
		$(function() {
			...
			if(JSON.parse(localStorage.getItem('onefjrobj'))) {
//				var onefjrobj = JSON.parse(localStorage.getItem('onefjrobj'));
//				$(".fjrusername").val(onefjrobj.fjrname);
//				$(".fjrtel").val(onefjrobj.fjrtel);
//				$(".fjraddress").val(onefjrobj.fjrtel);
//				$(".fjrDaddrs").val(onefjrobj.fjraddress);
